...
def GenerateMaps():
    ...
    var = mapGen.makeMaps(settingsList[1][1], filedialog.askopenfilenames(initialdir = settingsList[0][1], parent=mainScreen, title='Choose a file'), settingsList[2][1], settingsList[3][1])
    print(str(var[3]))
...
btn3 = Button(NavBar, text="Reload", command = reload)
btn3.pack(side = 'left')
